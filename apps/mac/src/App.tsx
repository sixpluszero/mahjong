...
export default function App(): JSX.Element {
  ...
  return <SafeAreaView style={styles.page}><ScrollView contentContainerStyle={styles.wrap}><View style={styles.card}>
    ...
    <View style={styles.row}><TextInput style={[styles.input,styles.nameInput]} value={state.name} onChangeText={(name)=>setState(s=>({...s,name}))} placeholder='Name'/><Btn text={t(lang,'randomName')} onPress={()=>setState(s=>({...s,name:genRandomName()}))}/><Btn text={t(lang,'hello')} onPress={()=>run(()=>runtime.hello(state.name))}/></View>
